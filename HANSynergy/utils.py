...
cell_embedding_dict = get_dict_from_json_filename('./data/drugcombdb/context_set_m.json')
...
def get_drug_feature(
    ...
    cid_smile_dict = get_dict_from_json_filename('./data/drugcombdb/cid_smile.json')
